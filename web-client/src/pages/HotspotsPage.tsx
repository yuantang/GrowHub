                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span
                          className={cn("text-xs font-medium", heatLevel.color)}
                        >
                          🔥 {heatLevel.label}
                        </span>
                      </div>
                      ...
                      <div
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          if (hotspot.author_url)
                            window.open(hotspot.author_url, "_blank");
                        }}
                      >
                        {hotspot.author_avatar && (
                          <img
                            src={hotspot.author_avatar}
                        ...
                        <span
                          className={
                            hotspot.author_url ? "hover:underline" : ""
                          }
                        >
                      ...
                      <div className="text-xs text-muted-foreground mt-2">
                        ...
                        {hotspot.publish_time
                          ? new Date(hotspot.publish_time).toLocaleDateString()
                          : "-"}
                      </div>
                    </div>
